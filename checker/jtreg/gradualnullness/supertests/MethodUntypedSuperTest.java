 ...
 * runtime test.
 *
 * @run shell MethodUntypedSuperTest.sh
 */
...
public class MethodUntypedSuperTest extends MethodUntypedSuperTestParent {
  public static void main(String [] args) {
    MethodUntypedSuperTest foo = new MethodUntypedSuperTest();
    foo.a();
  }
