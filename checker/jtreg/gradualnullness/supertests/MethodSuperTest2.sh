...
javap -c $TESTCLASSES/MethodSuperTest2.class | grep -q "[0-9]*: invokespecial #[0-9]*[[:space:]]*// Method MethodSuperTest2Parent.f_\$maybe:(Ljava/lang/Integer;)Ljava/lang/Integer;"
